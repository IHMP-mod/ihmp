...
NDefines.NResistance.GARRISON_EQUIPMENT_LOST_BY_ATTACK = 0.014	--was 0.2 	-- Ratio of equipment lost by garrison at each attack on garrison (this number will be reduced by the hardness of garrison template)
...
NDefines.NMilitary.BASE_DIVISION_BRIGADE_GROUP_COST = 12	-- was 20 --Base cost to unlock a regiment slot,
NDefines.NMilitary.BASE_DIVISION_BRIGADE_CHANGE_COST = 6	-- was 5  --Base cost to change a regiment column.
NDefines.NMilitary.BASE_DIVISION_SUPPORT_SLOT_COST = 6		-- was 10 --Base cost to unlock a support slot
...
NDefines.NNavy.AGGRESSION_TORPEDO_EFFICIENCY_ON_LIGHT_SHIPS = 6   -- was 0.1 -- ratio for scoring for different gun types against light ships
NDefines.NNavy.AGGRESSION_TORPEDO_EFFICIENCY_ON_HEAVY_SHIPS = 9999   -- was 1.1 -- ratio for scoring for different gun types against heavy ships
NDefines.NNavy.AGGRESSION_HEAVY_GUN_EFFICIENCY_ON_LIGHT_SHIPS = 100 -- was 0.25 -- ratio for scoring for different gun types against light ships
